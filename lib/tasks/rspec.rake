...
#   Rake::SpecTask.new(:doc) do |t|
#     t.spec_opts = ["--format", "specdoc", "--dry-run"]
#     t.spec_files = FileList['spec/**/*_spec.rb']
#   end
#
#   desc "Print Specdoc for all plugin examples"
#   Rake::SpecTask.new(:plugin_doc) do |t|
#     t.spec_opts = ["--format", "specdoc", "--dry-run"]
...
#     Rake::SpecTask.new(sub => spec_prereq) do |t|
#       t.spec_opts = ['--options', "\"#{Rails.root}/spec/spec.opts\""]
...
#   Rake::SpecTask.new(:plugins => spec_prereq) do |t|
#     t.spec_opts = ['--options', "\"#{Rails.root}/spec/spec.opts\""]
...
#     Rake::SpecTask.new(:rspec_on_rails) do |t|
#       t.spec_opts = ['--options', "\"#{Rails.root}/spec/spec.opts\""]
