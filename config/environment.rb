...
Rails::Initializer.run do |config|
  ...
  config.gem 'delayed_job', :lib => 'delayed_job', :source => 'http://gems.github.com', :version => '>=2.0.0'

  config.gem "thinking-sphinx", :lib => 'thinking_sphinx', :source => 'http://gemcutter.org', :version => '>= 1.3.8'
  config.gem 'ts-delayed-delta', :lib => 'thinking_sphinx/deltas/delayed_delta', :version => '>= 1.1.0', :source  => 'http://gemcutter.org'
